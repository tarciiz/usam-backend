...
public class StringUtil {
    ...
    public static String toMD5(String plaintext) throws Exception {
        if (StringUtil.getInstance().isNullOrEmpty(plaintext)) {
        ...
        try {
            ...
            new Exception("Erro ao descriptografar a senha").printStackTrace();
        }
        return null;
    }

    public static boolean compareMD5(String md5, String plaintext) throws Exception {
